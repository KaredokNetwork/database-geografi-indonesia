CREATE TABLE `ref_city` (
  ...
  `parent` VARCHAR(15) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `code` (`code`),
  INDEX `prov_code` (`parent`)
)
ENGINE=InnoDB
...
ALTER TABLE `ref_city`
  ADD CONSTRAINT `fk_prov_kota` FOREIGN KEY (`parent`) REFERENCES `ref_province` (`code`) ON UPDATE CASCADE ON DELETE SET NULL;
*/
--
-- Dumping data for table `ref_city`
--

INSERT INTO `ref_city` (`code`, `name`, `parent`) VALUES
